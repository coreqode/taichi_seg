...
class NeRFSystem(LightningModule):
    ...
    def training_step(self, batch, batch_nb, *args):
        ...
        if not self.hparams.perf:
            ...
            #self.log('train/seg_loss', loss_d['seg'], True)
    ...
    def val_on_training(self, batch):
        ...
        seg_pred = rearrange(results['seg'].cpu().numpy(), '(h w) c -> 1 c h w', h=h)[0][0]
        ...
        imageio.imsave(os.path.join(self.val_dir, f'depth_{idx:03d}.png'),
                       depth)
        imageio.imsave(os.path.join(self.val_dir, f'seg_{idx:03d}.png'),
                       seg_pred)
