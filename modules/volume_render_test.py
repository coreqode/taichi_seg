...
@ti.kernel
def composite_test(
    sigmas: ti.types.ndarray(ndim=2), rgbs: ti.types.ndarray(ndim=3), segs: ti.types.ndarray(ndim=3),
    ...
    depth: ti.types.ndarray(ndim=1), rgb: ti.types.ndarray(ndim=2), seg: ti.types.ndarray(ndim=2)):
